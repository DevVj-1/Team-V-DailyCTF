...
FEEDBACK_CHANNEL_ID =1125838771900911758
...
async def on_guild_join(guild):
    ...
    if channel is not None:
        # Introduction
        await channel.send(
            "Hello, thanks for adding Team-Valhalla-X-DailyCTF Robot to your server! 🎉\nTeam-V-X-DailyCTF is a bot designed to automate and enhance the experience of hosting Capture The Flag challenges, making it seamless for both organizers and participants."
        )
...
class SetChallengeModal(discord.ui.Modal, title="Set a Challenge"):
    ...
    file_input = discord.ui.TextInput(
        ...
        placeholder="Optional: Past link of the  Attachment (GitHub)",
    )
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        formatted_message = (
            ...
            f"**Link:**`{challenge_data['chal_file']}`"
        )
...
class FeedbackModal(discord.ui.Modal, title="Send us your feedback"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        await interaction.response.send_message(
            "Thank you for your feedback! Join the Official bot server to check the status of your feedback here: https://discord.gg/NB6aXA9gsE",
            ephemeral=True,
        )

    async def on_error(self, interaction: discord.Interaction, error: Exception):
        await interaction.response.send_message(
            "Failed to send feedback!,Click here --> [Contact Creator](https://discordapp.com/users/1057228474152140842) Or you can  feedback here: https://discord.gg/NB6aXA9gsE",
            ephemeral=True,
        )
...
async def help_command(interaction: discord.Interaction):
    embed = discord.Embed(
        title="TeamValhalla-X-DailyCTF Robot Help",
        description="List of available commands. TeamValhalla-X-DailyCTF is a Discord-Bot to automate ...",
        color=0x55A7F7,
    )
